[myproject1-f224] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myproject1-f224] container is NOT running**.

.. tip::
   You must have your [myproject1-f224] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   chiraghanda/myproject1-f224-amd64 (https://hub.docker.com/r/chiraghanda/myproject1-f224-amd64)
...
.. important::
   docker run -d -p 35433:35433 -p 57869:57869 -p 58791:58791 \-\-env TSS=0 \-\-env SOLUTIONNAME=myproject1-f224 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myproject1-f224 \-\-env GITUSERNAME=chiraghanda  \-\-env GITREPOURL=https://github.com/chiraghanda/raspberrypi \-\-env SOLUTIONEXTERNALPORT=35433  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=57869  \-\-env SOLUTIONVIPERVIZPORT=58791 \-\-env DOCKERUSERNAME='chiraghanda'  \-\-env EXTERNALPORT= \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='chiraghanda22@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  chiraghanda/myproject1-f224-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=58791
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=35433
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - chiraghanda/myproject1-f224-amd64
...
It can be accessed by entering: http://localhost:57869
...
.. important::
   http://localhost:58791/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:58791/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:58791/<html file>
...
[myproject1-f224] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/chiraghanda/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myproject1-f224
...
.. important::
   https://myproject1-f224.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myproject1-f224
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=35433, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46665, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45887, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40287, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34973, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38965, HPDEHOST=127.0.1.1, HPDEPORT=44577, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36487

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3014-myproject1-f224,solution_preprocessing_dag-myproject1-f224, python-preprocess-5690-myproject1-f224,solution_preprocessing_dag-myproject1-f224, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
